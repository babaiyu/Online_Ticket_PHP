                ...
                <div class="card-panel default">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM rute WHERE (CONVERT(id_rute USING utf8) LIKE '%$cari%' OR CONVERT(depart USING utf8) LIKE '%$cari%' OR CONVERT(rute_from USING utf8) LIKE '%$cari%' OR CONVERT(`rute_to` USING utf8) LIKE '%$cari%' OR CONVERT(price USING utf8) LIKE '%$cari%' OR CONVERT(id_trans USING utf8) LIKE '%$cari%') ";
